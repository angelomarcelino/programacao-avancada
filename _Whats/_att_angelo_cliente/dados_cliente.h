...
typedef vector<Mensagem>::const_iterator Citr_Msg;
...
public:
  ...
  inline vector<Conversa>::const_iterator begin() const {return LC.begin();}
  inline vector<Conversa>::const_iterator end() const {return LC.end();}
...
typedef vector<Conversa>::const_iterator Citr_Cnv;
